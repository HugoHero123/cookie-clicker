...
var $author$project$Main$initPointsPerClick = 1;
var $author$project$Main$pointsPerClick = function (model) {
	var _v0 = model.p;
	if (!_v0) {
		return $author$project$Main$initPointsPerClick;
	} else {
		return $author$project$Main$initPointsPerClick + ((model.p / 10) * $author$project$Main$initPointsPerClick);
	}
};
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							l: model.l + $author$project$Main$pointsPerClick(model)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
			...
			case 2:
				return _Utils_Tuple2(
					(model.l < 10) ? model : _Utils_update(
						model,
						{p: model.p + 1, l: model.l - 10}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{l: model.l + (model.p * 0.1)}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$ClickedBuyCursor = 2;
...
var $author$project$Main$roundPoints = function (x) {
	...
	return A2(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromFloat(
									$author$project$Main$roundPoints(model.l)))
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$class('cookie')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('🍪')
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('right-sidebar')
					]),
				_List_fromArray(
					[
						A2(
